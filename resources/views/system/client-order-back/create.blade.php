            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                    <div class="row">
                        ...
                        {!! Form::open(['route' => isset($result->id) ? ['system.client-order-back.update',$result->id]:'system.client-order-back.store','method' => isset($result->id) ?  'PATCH' : 'POST','files'=> true]) !!}
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block card-dashboard">
                                        <div class="row" >

                                        <div class="form-group col-sm-8{!! formError($errors,'client_id',true) !!}">
                                            <div class="controls">
                                        ...
                                        <div class="form-group col-sm-4{!! formError($errors,'date',true) !!}">
                                            ...
                                            <div class="form-group col-sm-12{!! formError($errors,'client_order_id',true) !!}">
                                                <div class="controls">
                                                    {{ Form::label('client_order_id',__('Client Order ID :')) }}
                                                    {!! Form::select('client_order_id',isset($result->id) ? [$result->client_order_id =>$result->client_order_id]:[''=>__('Select Client Order ID')],isset($result->id) ? $result->client_order_id:old('client_order_id'),['style'=>'width: 100%;' ,'id'=>'client_order_id','class'=>'form-control col-md-12']) !!}
                                                </div>
                                                {!! formError($errors,'client_order_id') !!}
                                            </div>
