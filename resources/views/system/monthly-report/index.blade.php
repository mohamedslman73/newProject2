                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('total_money_staff1',__('Total Money Staff From')) }}
                                    {!! Form::number('total_money_staff1',null,['class'=>'form-control','id'=>'total_money_staff1']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('total_money_staff2',__('Total Money Staff To')) }}
                                    {!! Form::number('total_money_staff2',null,['class'=>'form-control','id'=>'total_money_staff2']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('cleaner_id',[''=>__('Select Cleaner')],null,['style'=>'width: 100%;' ,'id'=>'cleaner_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
