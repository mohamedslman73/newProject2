                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('clientSelect2',__('Client')) }}
                                    <div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('status',[__('Select Status'),'in-progress'=>__('In Progress'),'hold'=>__('Hold'),'in-active'=>__('In-Active')],null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
