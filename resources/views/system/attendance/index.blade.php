                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('cleaner_id',['0'=>'Select Cleaner'],null,['style'=>'width: 100%;' ,'id'=>'cleaner_id','class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('group_id',__('Group ID')) }}
                                    {!! Form::number('group_id',null,['class'=>'form-control','id'=>'id']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {!! Form::label('project_id', __('Project')) !!}
                                    {!! Form::select('project_id',['0'=>'Select Project'],null,['style'=>'width: 100%;' ,'id'=>'project_id','class'=>'form-control']) !!}
                                </fieldset>
                            </div>
