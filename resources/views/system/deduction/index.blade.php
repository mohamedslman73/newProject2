                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('deduction_from',__('Deduction From')) }}
                                    <div>
                                    {!! Form::select('deduction_from',[''=>__('Select Staff Deduction')],isset($result->id) ? $result->deduction_from:old('deduction_from'),['style'=>'width: 100%;','id'=>'deduction_from','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col-md-6">
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#deduction_from','staff','',"{{route('system.ajax.get')}}");
