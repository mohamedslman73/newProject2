                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('date_from1',__('Date From 1')) }}
                                    {!! Form::text('date_from1',null,['class'=>'form-control datepicker','id'=>'date_from1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('date_from2',__('Date From 2')) }}
                                    {!! Form::text('date_from2',null,['class'=>'form-control datepicker','id'=>'date_from2']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('date_to1',__('Date To 1')) }}
                                    {!! Form::text('date_to1',null,['class'=>'form-control datepicker','id'=>'date_to1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('date_to2',__('Date To 2')) }}
                                    {!! Form::text('date_to2',null,['class'=>'form-control datepicker','id'=>'date_to2']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('projectSelect2',__('Project')) }}
                                    <div>
                                        {!! Form::select('project_id',[''=>__('Select Project')],null,['style'=>'width: 100%;' ,'id'=>'projectSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('quotationSelect2',__('Quotation')) }}
                                    <div>
                                        {!! Form::select('quotation_id',[''=>__('Select Quotation')],null,['style'=>'width: 100%;' ,'id'=>'quotationSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#projectSelect2','project','',"{{route('system.ajax.get')}}");
        ajaxSelect2('#quotationSelect2','quotation','',"{{route('system.ajax.get')}}");
