                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('expense_causes_id',__('Expense Causes')) }}
                                    <div>
                                        {!! Form::select('expense_causes_id',['0'=>'Select Expense Causes']+$expense_causes,null,['style'=>'width: 100%;','class'=>'form-control col-md-12 expense_causes_id']) !!}
                                    </div>
                                </fieldset>
                            </div>
