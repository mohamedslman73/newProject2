                                    ...
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'parent_id',true) !!}">
                                            <div class="controls">
                                                ...
                                                @if(isset($result->id))
                                                <select name="parent_id" id="parent_id" class="form-control col-md-12" style="width: 100%;"> {{getCategoryTreeSelect(0,'',$result->parent_id)}} </select>
                                                @else
                                                 <select name="parent_id" id="parent_id" class="form-control col-md-12" style="width: 100%;"> {{getCategoryTreeSelect(0,'',old('parent_id'))}} </select>
                                                    @endif
                                               </div>
