                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('number_km1',__('Number Of Km From')) }}
                                    {!! Form::number('number_km1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('number_km2',__('Number Of Km To')) }}
                                    {!! Form::number('number_km2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('bus_id',[''=>__('Select Bus')],null,['style'=>'width: 100%;' ,'id'=>'bus_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('project_id',[''=>__('Select Project')],null,['style'=>'width: 100%;' ,'id'=>'project_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('driver_id',[''=>__('Select Driver')],null,['style'=>'width: 100%;' ,'id'=>'driver_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#driver_id','staff','',"{{route('system.ajax.get')}}");
