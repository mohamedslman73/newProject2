                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {!! Form::label('call_details', __('Call details').':') !!}
                                        {!! Form::textarea('call_details',isset($result->id) ? $result->details:old('call_details'),['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::text('call_propose',null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-xs-12">
                    <h4>
                        ...
                        @if(staffCan('download.call-tracking.excel'))
