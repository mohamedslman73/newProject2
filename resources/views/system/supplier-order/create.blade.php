            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                    <div class="row">
                        ...
                        {!! Form::open(['route' => isset($result->id) ? ['system.order.update',$result->id]:'system.order.store','method' => isset($result->id) ?  'PATCH' : 'POST','files'=> true]) !!}
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-6{!! formError($errors,'minus',true) !!}">
                                            <div class="controls">
                                        ...
                                        <div class="form-group col-sm-6{!! formError($errors,'plus',true) !!}">
                                            <div class="controls">
                                ...
                                <div class="card-header">
                                    <div class="card-body">
                                        <div class="card-block card-dashboard col-md-12"  style="float: right">
                                            <div class="controls">
                                                {{ Form::label('price',__('total')) }}
                                                {!! Form::number('total_price','',['id'=>'total_price000','class'=>'form-control','disabled'=>'disabled']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('footer')
    ...
    ajaxSelect2('.item_id{{$key}}','item','',"{{route('system.ajax.get')}}");
       ...
       @else
        ...
        var  asd =  $('#total_price000').val(total_price);

            $('#total_price000').html(total_price);
        }
