                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('total_price1',__('Total Price From')) }}
                                    {!! Form::number('total_price1',null,['class'=>'form-control','id'=>'total_price1']) !!}
                                </fieldset>
                            </div> <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('total_price2',__('Total Price To')) }}
                                    {!! Form::number('total_price2',null,['class'=>'form-control','id'=>'total_price2']) !!}
                                </fieldset>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::number('minus',null,['class'=>'form-control','id'=>'minus']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('plus',__('Plus')) }}
                                    {!! Form::number('plus',null,['class'=>'form-control','id'=>'plus']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('supplier_id',[''=>__('Select Supplier')],null,['style'=>'width: 100%;' ,'id'=>'supplierSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#supplierSelect2','supplier','',"{{route('system.ajax.get')}}");
