                        ...
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!! Form::select('nationality',array_merge(['Select Country'],$country_name),isset($result->id) ? $result->nationality:old('nationality'),['style'=>'width:100%','class'=>'form-control nationality']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::number('passport_no',null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
