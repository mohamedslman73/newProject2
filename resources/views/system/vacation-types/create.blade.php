            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                    <div class="row">
                            ...
                            @endif
                            {!! Form::open(['route' => isset($result->id) ? ['system.type.update',$result->id]:'system.type.store','method' => isset($result->id) ?  'PATCH' : 'POST']) !!}

                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2>{{__('Vacation Type Data')}}</h2>
                                    </div>
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'description_en',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('after_months', __('Vacations After X Months')) !!}
                                                {!! Form::number('after_months',isset($result->id) ? $result->after_months:old('after_months'),['class'=>'form-control']) !!}
                                            </div>
                                            {!! formError($errors,'after_months') !!}
                                        </div>
