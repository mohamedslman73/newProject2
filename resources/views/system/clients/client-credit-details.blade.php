                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tr style="background-color: #00BCD4">
                                                    ...
                                                    <td colspan="3">{{amount($credit,true)}}</td>
                                                </tr>
                                                @foreach($tableColumns as $value)
                                                    ...
                                                    @if($value['type'] == 'client_order')
                                                        <tr style="background-color: yellow">
                                                            ...
                                                            <td>{{$value['date']}}</td>
                                                            <td><a target="_blank"
                                                                   href="{{route('system.client-orders.show',$value['id'])}}">View</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    @elseif($value['type'] == 'client_revenue')
                                                        <tr style="background-color: greenyellow">
                                                            <td>{{$value['id']}}</td>
                                                            <td> Revenue</td>
                                                            <td>{{amount($value['amount'],true)}}</td>
                                                            <td>{{ amount($credit -= $value['amount'],true) }}</td>
                                                            <td>{{$value['date']}}</td>
                                                            <td><a target="_blank"
                                                                   href="{{route('system.profits.show',$value['id'])}}">View</a>
                                                            </td>
                                                        </tr>
                                                    @elseif($value['type'] == 'client_order_back')
                                                        ...
                                                        <tr style="background-color: red">
                                                            ...
                                                            <td>{{$value['date']}}</td>
                                                            <td><a target="_blank"
                                                             href="{{route('system.client-order-back.show',$value['id'])}}">View</a>
                                                            </td>
                                                        </tr>
                                                    @endif
                                                @endforeach
