                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                {{--<tr>--}}
                                                    ...
                                                    {{--<td>{{amount($total_orders,true)}}</td>--}}
                                                {{--</tr>--}}
                                                {{--<tr>--}}
                                                    {{--<td>Total Paid</td>--}}
                                                    {{--<td>{{amount($total_revenue,true)}}</td>--}}
                                                {{--</tr>--}}
                                                {{--<tr>--}}
                                                    {{--<td>Rest</td>--}}
                                                    {{--<td>@php echo amount(( $result->ini_credit + $total_orders ) - $total_revenue,true); @endphp</td>--}}
                                                {{--</tr>--}}
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        $dataTableVar = $('#egpay-datatable-report').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            "ajax": {
                "url": "{{route('system.client-report')}}?id={{$result->id}}",
                "type": "GET",
                "data": function(data){
        ...
        $dataTableVar = $('#egpay-datatable-order').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            "ajax": {
                "url": "{{route('system.client-orders.index')}}?client_id={{$result->id}}",
                "type": "GET",
                "data": function(data){
                    data.isDataTable = "true";
                }
        ...
        $dataTableVar = $('#egpay-datatable-order-back').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            "ajax": {
                "url": "{{route('system.client-order-back.index')}}?client_id={{$result->id}}",
                "type": "GET",
                "data": function(data){
                    data.isDataTable = "true";
                }
        ...
        $dataTableVar = $('#egpay-datatable-deposits').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            "ajax": {
                "url": "{{route('system.profits.index')}}?client_id={{$result->id}}",
                "type": "GET",
                "data": function(data){
                    data.isDataTable = "true";
                }
