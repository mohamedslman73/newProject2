                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6{!! formError($errors,'project_id',true) !!}">
                                <div class="controls">
                                    ...
                                    {!! Form::select('project_id',['0'=>'Select Project']+$projects,old('project_id'),['class'=>'form-control project_id']) !!}
                                </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('status',[''=>__('Select Status'),'pending'=>__('Pending'),'closed'=>__('Closed'),'solved'=>__('Solved')],null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('staffSelect2',__('Complaint in employee')) }}
                                    <div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_by_staff_id',__('Created By')) }}
                                    <div>
                                        {!! Form::select('created_by_staff_id',[''=>__('Select Staff')],null,['style'=>'width: 100%;' ,'id'=>'created_by_staff_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#created_by_staff_id','staff','',"{{route('system.ajax.get')}}");
