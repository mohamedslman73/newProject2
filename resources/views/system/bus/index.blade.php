                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('fixed_distance',__('Number Of Km That the Bus Moved it From')) }}
                                    {!! Form::number('fixed_distance1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('fixed_distance',__('Number Of Km That the Bus Moved it To')) }}
                                    {!! Form::number('fixed_distance2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('variable_distance',__('Number Of Km for Change Oil From')) }}
                                    {!! Form::number('variable_distance1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('variable_distance',__('Number Of Km for Change Oil To')) }}
                                    {!! Form::number('variable_distance2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::text('bus_number',null,['class'=>'form-control','id'=>'name']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {!! Form::label('bus_brand_id', __('Brand')) !!}
                                    {!! Form::select('bus_brand_id',['0'=>'Select Brand']+$brand,null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {{ Form::label('driver',__('Bus Driver')) }}
                                        <div>
                                            {!! Form::select('driver',[''=>__('Select Driver')],null,['style'=>'width: 100%;' ,'id'=>'driver','class'=>'form-control col-md-12']) !!}
                                        </div>
                                    </fieldset>
                                </div>
