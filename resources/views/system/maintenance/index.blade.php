                        ...
                        <div class="row">
                            ...
                            {{--<div class="col-md-12">--}}
                                {{--<fieldset class="form-group">--}}
                                    ...
                                    {{--{!! Form::select('bus_id',['0'=>'Select bus']+$bus,null,['class'=>'form-control']) !!}--}}
                                {{--</fieldset>--}}
                            {{--</div>--}}
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('maintenance_date1',__('Maintenance Date From')) }}
                                    {!! Form::text('maintenance_date1',null,['class'=>'form-control datepicker','id'=>'maintenance_date1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('maintenance_date2',__('Maintenance Date To')) }}
                                    {!! Form::text('maintenance_date2',null,['class'=>'form-control datepicker','id'=>'maintenance_date2']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
