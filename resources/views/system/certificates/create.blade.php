            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                    <div class="row">
                            ...
                            @endif
                            {!! Form::open(['route' => isset($result->id) ? ['system.certificates.update',$result->id]:'system.certificates.store','method' => isset($result->id) ?  'PATCH' : 'POST']) !!}

                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2>{{__('Certificates Data')}}</h2>
                                    </div>
