                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('form_date1',__('Vacation From Date From')) }}
                                    {!! Form::text('form_date1',null,['class'=>'form-control datepicker','id'=>'form_date1']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('form_date2',__('Vacation From Date To')) }}
                                    {!! Form::text('form_date2',null,['class'=>'form-control datepicker','id'=>'form_date2']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('to_date1',__('Vacation To Date From')) }}
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('to_date2',__('Vacation To Date To')) }}
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('num_of_days1',__('Num Of Days From')) }}
                                    {!! Form::number('num_of_days1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('num_of_days2',__('Num Of Days To')) }}
                                    {!! Form::number('num_of_days2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
