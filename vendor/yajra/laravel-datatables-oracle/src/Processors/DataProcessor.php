...
class DataProcessor
{
    ...
    public function process($object = false)
    {
        ...
        foreach ($this->results as $row) {
            ...
            $value = $this->removeExcessColumns($value,$data);
     ...
     * @return array
     */
    protected function removeExcessColumns(array $data,array $dataToRemove = [])
    {
        $this->excessColumns = array_merge($this->excessColumns,array_keys($dataToRemove));
